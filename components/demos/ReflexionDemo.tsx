...
const ReflexionDemo: React.FC<DemoProps> = ({ apiKey }) => {
    ...
    const runChain = useCallback(async () => {
        ...
        let reflection = '';
        for await (const chunk of streamGeminiResponse(apiKey, reflectionPrompt)) {
            reflection += chunk;
            setSteps(prev => {
                const newSteps = [...prev];
        ...
        let finalCode = '';
         for await (const chunk of streamGeminiResponse(apiKey, retryPrompt)) {
            finalCode += chunk;
            setSteps(prev => {
                const newSteps = [...prev];
        ...
        <div className="space-y-5">
            <div className="space-y-2">
                ...
                <div className="flex flex-col sm:flex-row gap-4">
                    ...
                    <button
                        onClick={runChain}
                        disabled={isLoading || !task || !isApiKeySet}
