...
const SimpleChainDemo: React.FC = () => {
  ...
  const runChain = useCallback(async () => {
    ...
    const initialSteps: ChainStep[] = [
      { title: 'Step 1: Generate Title', prompt: `Generate a creative title for a sci-fi story about ${topic}.`, output: '', isLoading: true, isComplete: false },
      { title: 'Step 2: Generate Synopsis', prompt: '', output: '', isLoading: false, isComplete: false },
    ];
